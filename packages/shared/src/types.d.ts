import type { User, UserIdentity, UserSession, WalletAccount, Model, ModelPricing, GenerationTask, GenerationOutput, GenerationEvent } from '@prisma/client';
...
export type TaskFull = TaskWithOutputs & {
    user: User;
};
